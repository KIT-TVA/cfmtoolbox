The SVG export plugin enables the export of CFM models to SVG files. The SVG file visualizes the CFM model in a tree structure with their respective cardinalities.
